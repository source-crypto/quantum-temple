...
import { ShieldCheck, Wallet, Activity, ExternalLink } from 'lucide-react';
    ...
    <div className="p-6 min-h-screen bg-gradient-to-br from-slate-950/40 to-slate-900/30 text-slate-100">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-purple-300 to-indigo-300 bg-clip-text text-transparent">ECB Macro Dashboard</h1>
            <p className="text-sm text-slate-400">Policy rates • Inflation • Eurosystem & NCB assets • Real-rate spreads</p>
          </div>
          <div className="flex gap-2">
            <Link to={createPageUrl('Markets')}>
              <Button variant="outline" className="border-purple-900/30">Open Markets</Button>
            </Link>
        ...
        {/* Wallet & Transparency quick actions */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="bg-slate-900/60 border-purple-900/30">
            <CardContent className="p-4 flex items-center justify-between">
              <div className="space-y-1">
                ...
                <div className="text-xs text-slate-500">Connect to enable transactions & interactions.</div>
              </div>
              <WalletConnectButton />
            </CardContent>
          </Card>
          <Card className="bg-slate-900/60 border-purple-900/30">
            <CardContent className="p-4 flex items-center justify-between">
              <div className="space-y-1">
                ...
                <div className="text-xs text-slate-500">Review currency and ledger transparency.</div>
              </div>
          ...
          <Card className="bg-slate-900/60 border-purple-900/30">
            <CardContent className="p-4 flex items-center justify-between">
              <div className="space-y-1">
                <div className="text-sm text-slate-300 flex items-center gap-2"><ShieldCheck className="w-4 h-4" /> Interactions</div>
                <div className="text-xs text-slate-500">Access governance and operations.</div>
              </div>
              <Link to={createPageUrl('Governance')}>
                <Button variant="outline" className="border-purple-900/30">Open Governance</Button>
              </Link>
            </CardContent>
          </Card>
        </div>
